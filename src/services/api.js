...
//   requestJoin: (threadId, userId) => {
//     return api.post(`/api/threads/${threadId}/join`, { userId });
//   },
  
//   handleRequest: (threadId, userId, approve, creatorId) => {
//     return api.post(`/api/threads/${threadId}/requests`, { 
//       userId, 
//       approve, 
...
//   sendMessage: (threadId, messageData) => {
//     return api.post(`/api/threads/${threadId}/messages`, messageData);
//   }
// };
...
export const gossipsAPI = {
  ...
  addReply: (gossipId, commentId, replyData) => {
    return api.post(`/api/gossips/${gossipId}/comments/${commentId}/replies`, replyData);
  },
